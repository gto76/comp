...
object Comp {
  ...
  var ramValues: Array[Array[Boolean]] = null //readRamFromFile(TEST_FILE)
  var ram: Ram = null //new Ram(ramValues)
  var proc: Proc = null // new Proc()
  ...
  def main(args: Array[String]): Unit = {
    ...
    val file: BufferedSource = if (arguments.length > 0) {
      ...
      //Source.fromURL(getClass.getResource(filename)) // scala.io.Source.fromFile(DRAWING_FILE, "UTF-8").mkString ?
